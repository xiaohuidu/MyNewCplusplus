...
比如：1.  double&& rr2 = x + y;　　&rr2;　　rr2 = 9.4;　　右值引用 rr2 引用右值 x + y 后，该表达式的返回值被存储到特定的位置，不能取表达式返回值 x + y 的地址，但是可以取 rr2 的地址，也可以修改 rr2 。 const double&& rr4 = x + y; &rr4; 可以对 rr4 取地址，但不能修改 rr4，即写成rr4 = 5.3;会编译报错。2. const double&& rr4 = x + y;　　&rr4;　　可以对 rr4 取地址，但不能修改 rr4，即写成rr4 = 5.3;会编译报错
#### 2.2



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzMjUwMTc1NywtNjU4OTAwMDEyLDMzMz
YwNDM2Nyw2NDg3MDEzNDgsLTEyMjI1Mzg4MzQsLTU5MzA3NDI2
NiwtNTkzMDc0MjY2LDEwNDM3NDk0NTAsLTMyMzM0NzExLC01ND
Q1NjY4NTgsLTEyNjE1NzE3NTEsMTkwMTEzODc2NSwtOTI2OTk4
MTI5LDEwMTU3NTU4NTUsMTA4NTI5NTA3LDExOTk5NDEwODgsOT
Y5ODc0NTk5LC02NTMwOTM1NTIsLTE4NjY3MjE0NCwtMTYyNjEz
NjAwN119
-->