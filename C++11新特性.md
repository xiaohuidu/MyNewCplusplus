...
加入的最重大语言特性之一。从实践角度讲，它能够完美解决C++中长久以来为人所诟病的临时对象效率问题。从语言本身讲，它健全了C++中的引用类型在左值右值方面的缺陷。从库设计者的角度讲，它给库设计者又带来了一把利器。从库使用者的角度讲，不动一兵一卒便可以获得“免费的”效率提升。
左值和右值的辨识: 可以取地址则为左值， 不可取地址则为右值。
#### 2.2



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2ODY5ODIyMSwtMTIyMjUzODgzNCwtNT
kzMDc0MjY2LC01OTMwNzQyNjYsMTA0Mzc0OTQ1MCwtMzIzMzQ3
MTEsLTU0NDU2Njg1OCwtMTI2MTU3MTc1MSwxOTAxMTM4NzY1LC
05MjY5OTgxMjksMTAxNTc1NTg1NSwxMDg1Mjk1MDcsMTE5OTk0
MTA4OCw5Njk4NzQ1OTksLTY1MzA5MzU1MiwtMTg2NjcyMTQ0LC
0xNjI2MTM2MDA3LC0yMzMyNDkzMzQsLTE0OTQ4NTE1MTgsLTEx
NjUzNTE4MTNdfQ==
-->