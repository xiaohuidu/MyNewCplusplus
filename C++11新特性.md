...
#### 3.1 auto_ptr 被弃用原因
auto_ptr 是在C++98 引入的智能指针， 设计目的是用来自动管理动态分配的对象内存。 智能指针在栈上， 所指向的对象在堆上， 一旦函数调用结束， 智能指针被自动释放， ta
#### 3.2 unique_ptr
#### 4 xxx
# 2 新特性
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzM4ODI2OTUsLTU0NDU2Njg1OCwtMT
I2MTU3MTc1MSwxOTAxMTM4NzY1LC05MjY5OTgxMjksMTAxNTc1
NTg1NSwxMDg1Mjk1MDcsMTE5OTk0MTA4OCw5Njk4NzQ1OTksLT
Y1MzA5MzU1MiwtMTg2NjcyMTQ0LC0xNjI2MTM2MDA3LC0yMzMy
NDkzMzQsLTE0OTQ4NTE1MTgsLTExNjUzNTE4MTNdfQ==
-->