...
**当一个thread 需要返回一个值给创建它的thread， 它把值放到promise里， 底层实现让这个值出现在和这个promise 绑定的future里， 调用者可以读取这个值。**
https://www.stroustrup.com/C++11FAQ.html#std-future
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTk3MDAzMzIsLTQ4MDM0MDcyMSwxMT
k5NzExMzUzXX0=
-->