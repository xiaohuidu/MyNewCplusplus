...
std::move() 只是把左值转换成右值， 不会调用移动构造函数。 但是static_cast<Widget&&>(var1) 会调用移动构造hansh
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NDk3ODkyMSwyNDkxNzY2ODAsLTgzMz
AxODQ4NCwyMzY4NDYxNjUsLTcyNzc0MTgzMiwtNzg4Nzc4OTA1
LDE3NzU5Mjg2MjEsMTc5ODY1NDgwNSwtMjAzMzk4MjU1NCwtMT
