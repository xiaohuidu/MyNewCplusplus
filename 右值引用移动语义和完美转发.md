...
{
    Obj obj;
// 简单返回对象；一般有 NRVO。直接把obj移动出去而不是拷贝出(构造新的对象）。
    return obj;
}
Obj simple_with_move()
{
    Obj obj;
// move 会禁止 NRVO。 一个新的对象会被构造出来，调用移动构造函数。
    return std::move(obj);
}
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxMzQxNzAyNSwxNDQ0MTQ5Mjk3LC0xNj
gwOTEzNzE3LDUwNTI5NTY5OCwxODMyNzk0ODE4LC03MzQ0NzIz
NzAsNzIxNjA5Njk1LDE3NTEwNjI0MTQsNjA2NTMwMjAsLTIwOT
I1NzUzMywtMTg2ODY3NTgzOSwtMjA3MTM2ODkyMywtMjEyMjY3
MTUxNSw1MjYxMTYzMDIsMzIwNzI3Nzg1LDk4OTM2OTY0MiwyMD
Y1NzkwNjgxLDE1NTM5MDA1OTksMTAxNDM2MDk3OSwtMTcwMjg5
ODY0MF19
-->