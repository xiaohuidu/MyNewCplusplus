...
这里，我们同时有类型推导和一个带“`&&`”的参数，但是参数确不具有 “`T&&`” 的形式，而是 “`std::vector<t>&&`”。其结果就是，参数就只是一个**普通的rvalue reference**，而不是universal reference。 
Universal references只以 “`T&&`”的形式出现！即便是**仅仅加一个const限定符都会使得“`&&`”不再被解释为universal reference**:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjI1NTk4NDYsLTE2NzgyODkwMzIsLT
E3Mjc0MzczNDEsLTg0ODQyMzgyMCwtODEyNjI2NjgsMjQ5MTc2
NjgwLC04MzMwMTg0ODQsMjM2ODQ2MTY1LC03Mjc3NDE4MzIsLT
c4ODc3ODkwNSwxNzc1OTI4NjIxLDE3OTg2NTQ4MDUsLTIwMzM5
ODI1NTQsLTE5NTk3MDYyMTIsLTU1MjA5MTc0OCwtMTI1NDQzMT
UxNSw1NzIxOTU0NTEsLTg1NzAwMjk0NywtOTkyOTIxNzg1LC0x
NzkwMDQ2NjkxXX0=
-->