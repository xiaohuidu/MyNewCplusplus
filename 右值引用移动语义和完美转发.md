...
```
#### 3） std::move() 函数
-   std::move作用主要可以将一个**左值转换成右值**，从而可以调用C++11右值引用的移动构造函数
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjE2NTQwMzAsMTc1MTA2MjQxNCw2MD
Y1MzAyMCwtMjA5MjU3NTMzLC0xODY4Njc1ODM5LC0yMDcxMzY4
OTIzLC0yMTIyNjcxNTE1LDUyNjExNjMwMiwzMjA3Mjc3ODUsOT
g5MzY5NjQyLDIwNjU3OTA2ODEsMTU1MzkwMDU5OSwxMDE0MzYw
OTc5LC0xNzAyODk4NjQwLDk3MDUyMjk3NiwxMTI5Njc2MzQxLC
0yMjI2NzM5OTAsLTg1MDM2MjgzNSwtNjYzNDY3MzksLTE2Nzgy
ODkwMzJdfQ==
-->