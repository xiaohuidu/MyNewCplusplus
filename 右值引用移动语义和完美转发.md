...
```
类型声明当中的“`&&`”有的时候意味着rvalue reference，但有的时候意味着rvalue reference _或者_ lvalue reference。因此，源代码当中出现的 “`&&`” 有可能是 “`&`” 的意思，即是说，语法上看着像rvalue reference (“`&&`”)，但实际上却代表着一个lvalue reference (“`&`”)。 我没给它起个名字叫万能引用(universalrefernce)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5MzQ2MzY4MywtMTEwMzUyMzA0NiwxOD
