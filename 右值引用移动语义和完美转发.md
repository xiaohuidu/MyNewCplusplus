...
#### 6. 右值引用的使用场景和实际意义:  为了解决上述传值返回的拷贝问题，C++11标准就增加了**右值引用** 和 **移动语义。
-  **返回函数的局部变量**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwMzkyNDc5LDEwMTQzNjA5NzksLTE3MD
I4OTg2NDAsOTcwNTIyOTc2LDExMjk2NzYzNDEsLTIyMjY3Mzk5
MCwtODUwMzYyODM1LC02NjM0NjczOSwtMTY3ODI4OTAzMiwtMT
