...
在C++ 里，所有的原生类型、枚举、结构、联合、类都代表值类型，只有引用（&）和指针（*）才是引用类型。在 Java 里，数字等原生类型是值类型，类则属于引用类型。在Python 里，一切类型都是引用类型。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDUyMzkxNzQsLTc4ODc3ODkwNSwxNz
c1OTI4NjIxLDE3OTg2NTQ4MDUsLTIwMzM5ODI1NTQsLTE5NTk3
MDYyMTIsLTU1MjA5MTc0OCwtMTI1NDQzMTUxNSw1NzIxOTU0NT
EsLTg1NzAwMjk0NywtOTkyOTIxNzg1LC0xNzkwMDQ2NjkxLDg0
NjE0ODg0NiwtMTkzMDE0OTM5NCwxNzk1MTEzMjY4LC0yMTI0Mz
M3NzU4LDcwMDMzMjA0NSwxMTQ4MzM2NjExLDUzODk3MDI0Miwt
MTIwOTUzMjMwN119
-->