...
```
只有在**发生类型推导的时候**  “`&&`” 才代表 universal reference 。**如果没有类型推导，就没有universal reference**。这种时候，类型声明当中的“`&&`”总是代表着rvalue reference。因此，如下代码没有发生类型推导， &&代表rvalue reference:
```cpp
template<typename T>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NjYyMjQ1MiwtMTY3ODI4OTAzMiwtMT
cyNzQzNzM0MSwtODQ4NDIzODIwLC04MTI2MjY2OCwyNDkxNzY2
ODAsLTgzMzAxODQ4NCwyMzY4NDYxNjUsLTcyNzc0MTgzMiwtNz
