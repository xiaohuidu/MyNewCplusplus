...
{
    Obj obj;
// move 会禁止 NRVO。 新的对象会被ceate出来返回。 调用移动构造函数无需拷贝。
    cout << &obj << endl;
    return std::move(obj);
}
Obj complicated(int n)
{
    Obj obj1;
    Obj obj2;
    // 有分支，一般无 NRVO。新的对象会被ceate出来返回。 调用移动构造函数无需拷贝。
    if (n % 2 == 0) {
        cout << &obj1 << endl;
        return obj1;
    } else {
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5NDI0NzUwLC0zNTEyMTc2MTIsLTEwMz
Q3NzI2NDMsMTQ0NDE0OTI5NywtMTY4MDkxMzcxNyw1MDUyOTU2
OTgsMTgzMjc5NDgxOCwtNzM0NDcyMzcwLDcyMTYwOTY5NSwxNz
UxMDYyNDE0LDYwNjUzMDIwLC0yMDkyNTc1MzMsLTE4Njg2NzU4
MzksLTIwNzEzNjg5MjMsLTIxMjI2NzE1MTUsNTI2MTE2MzAyLD
MyMDcyNzc4NSw5ODkzNjk2NDIsMjA2NTc5MDY4MSwxNTUzOTAw
NTk5XX0=
-->