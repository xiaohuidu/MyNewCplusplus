...
double&& rr3 = fmin(x, y);
```
> 右值引用的加入是C++ 11 最重大语言特性之一。从实践角度讲，它能够完美解决C++中长久以来为人所诟病的**临时对象效率问题**。从语言本身讲，它健全了C++中的引用类型在左值右值方面的缺陷。从库设计者的角度讲，它给库设计者又带来了一把利器。从库使用者的角度讲，不动一兵一卒便可以获得“免费的”效率提升。
...
可以对 rr4 取地址，但不能修改 rr4，即写成rr4 = 5.3;会编译报错
 ...
 2. 左值引用和右值引用的
那么左值引用是否可以引用右值？右值引用是否可以引用左值呢？_
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNDI5MjA0OCwxNzk4NjU0ODA1LC0yMD
MzOTgyNTU0LC0xOTU5NzA2MjEyLC01NTIwOTE3NDgsLTEyNTQ0
MzE1MTUsNTcyMTk1NDUxLC04NTcwMDI5NDcsLTk5MjkyMTc4NS
wtMTc5MDA0NjY5MSw4NDYxNDg4NDYsLTE5MzAxNDkzOTQsMTc5
NTExMzI2OCwtMjEyNDMzNzc1OCw3MDAzMzIwNDUsMTE0ODMzNj
YxMSw1Mzg5NzAyNDIsLTEyMDk1MzIzMDcsOTQzMDY4NDksMTcw
MTQ2Mzk4N119
-->