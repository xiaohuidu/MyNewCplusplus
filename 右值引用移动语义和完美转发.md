...
cout << &'w' << endl; 非法 
```
**右值只能出现在内置赋值操作符**(=)的右边， 这里强调是内置赋值操作符**。`string("hello")` 是 rvalue，但可以出现在左边：`string("hello") = string("world")`。注意，这个等号是 string class 定义的 operator=，不是 C++ **built-in**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODQ2MzgyNzgsLTEyNTYwMjUxMiwtOT
QwNjMzNTYyLC0yNDY3NTg1ODAsMTUwNjk4Nzg4LC0xNDQ1NDIy
NzkwLDk0MTc3MzgzNCwtMTY0ODA1NTgwOSwtMTE4MjI0MTQ1My
wxMjE5MTE4ODkyLDQ1ODUzMzk0MCwtOTg5NTgzMDQ3LC0zNTEy
MTc2MTIsLTEwMzQ3NzI2NDMsMTQ0NDE0OTI5NywtMTY4MDkxMz
cxNyw1MDUyOTU2OTgsMTgzMjc5NDgxOCwtNzM0NDcyMzcwLDcy
MTYwOTY5NV19
-->