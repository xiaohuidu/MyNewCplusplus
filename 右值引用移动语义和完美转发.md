...
auto&& var2 = var1; // var2 定义为一个universial reference, 
					// 赋值左值引用后， 变成了左值引用
```
_只有在发生类型推导_的时候 “`&&`” 才代表 universal reference 吗。如果没有类型推导，就没有universal reference。这种时候，类型声明当中的“`&&`”总是代表着rvalue reference。因此:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI5MzE0MjkxLC02NTEwMjA4MTgsMTE4OT
k0MjA5MywxOTUzMjA3MTgsLTExMDM1MjMwNDYsMTg1MjExNTUz
NSw3MzE5MDkyNzIsNDk1MTA1NTYyXX0=
-->