...
上面的内容精确的说明了一个 wa 是如何在经过类型推导和引用折叠之后，可以变为一个 lvalue reference的。实际上，universal reference 其实只是一个身处于引用折叠背景下的rvalue reference。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNzA2NjA0Myw3MjE2MDk2OTUsMTc1MT
