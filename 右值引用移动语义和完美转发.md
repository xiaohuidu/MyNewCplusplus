...
类型声明当中的“`&&`”有的时候意味着右值引用，但有的时候意味着rvalue reference  _或者_  lvalue reference。因此，源代码当中出现的 “`&&`” 有可能是 “`&`” 的意思，即是说，语法上看着像rvalue reference (“`&&`”)，但实际上却代表着一个lvalue reference (“`&`”)。 我没给它起个名字叫万能引用(universal, reference)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzgyODkwMzIsLTE3Mjc0MzczNDEsLT
g0ODQyMzgyMCwtODEyNjI2NjgsMjQ5MTc2NjgwLC04MzMwMTg0
ODQsMjM2ODQ2MTY1LC03Mjc3NDE4MzIsLTc4ODc3ODkwNSwxNz
